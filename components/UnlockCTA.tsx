    ...
    >
      <div className="p-8 md:p-10">
        ...
        <p className="text-gray-400 mb-6 leading-relaxed">
          AI isn&apos;t recommending you for a reason — usually several. Your full report
          uncovers every hesitation and tells you exactly what to change.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white/5 rounded-xl p-4 border border-white/10">
            ...
            <p className="text-white font-semibold text-sm mb-1">Every AI hesitation</p>
            <p className="text-gray-500 text-xs">Broken down with evidence, not just flagged</p>
          </div>
          ...
          <div className="bg-white/5 rounded-xl p-4 border border-white/10">
            ...
            <p className="text-white font-semibold text-sm mb-1">1-week action plan</p>
            <p className="text-gray-500 text-xs">Prioritized fixes you can start Monday</p>
          </div>
          ...
          <div className="bg-white/5 rounded-xl p-4 border border-white/10">
            ...
            <p className="text-white font-semibold text-sm mb-1">PDF report emailed</p>
            <p className="text-gray-500 text-xs">Professional consultant-style audit document</p>
          </div>
        </div>
