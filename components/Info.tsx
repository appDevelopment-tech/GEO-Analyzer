    ...
    answer: (
      <>
        ...
        <span className="block mb-2 text-gray-700">
          ...
          Most AI consultants charge $200+ per hour for this kind of insight—you
          get it instantly for a fraction of the cost. The full report shows
          exactly what to fix and why, so you can win more AI recommendations
          right away.
        </span>
      </>
    ),
