...
export const metadata: Metadata = {
  ...
  description: "Learn about Generative Engine Optimization (GEO), AI citation strategies, and how to improve your website's visibility in AI search results.",
  openGraph: {
    title: "Blog – GeoAnalyzer",
    description: "Learn about Generative Engine Optimization (GEO), AI citation strategies, and how to improve your website's visibility in AI search results.",
    url: `${baseUrl}/blog`,
      ...
      <main className="max-w-6xl mx-auto px-4 py-16">
        ...
        <section className="mb-16 bg-white rounded-2xl p-8 md:p-12 shadow-xl">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Learn how to optimize your website for AI recommendation engines. Practical guides,
            templates, and case studies on Generative Engine Optimization.
          </p>
        </section>
        ...
        {Object.entries(groupedPosts).map(([category, posts]) => {
          ...
          const colorClass = categoryColors[catInfo.color as keyof typeof categoryColors];
          return (
            <section key={category} className="mb-16">
              <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
                <span className={`w-3 h-3 rounded-full bg-${catInfo.color}-500`} />
                {catInfo.name}
              </h2>
        ...
        <section className="text-center bg-gray-800 rounded-xl p-8">
          ...
          <p className="text-gray-400 mb-8">
            Get actionable insights on your website's AI recommendation readiness.
          </p>
          <a
            href="/"
